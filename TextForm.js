...
export default function TextForm(props) {
  ...
  return (
    <>
      <div className="container" style={{color: props.mode==='dark'?'white':'#041d36'}}>
        <h1>{props.heading}</h1>
        <div className="mb-3">
          <textarea
            className="form-control"
            value={text}
            onChange={handleOnChange} style={{backgroundColor: props.mode==='dark'?'#041d36':'white', color: props.mode==='dark'?'white':'#041d36'}}
            id="myBox"
            rows="8"
          ></textarea>
      ...
      <div className="container my-3" style={{color: props.mode==='dark'?'white':'#041d36'}}>
